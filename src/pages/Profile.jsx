      ...
      <div className="max-w-lg mx-auto px-4 py-10">
        {isLoadingAuth ? (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-slate-800/80 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
              {mode === 'signup' && (
          ...
          >
            <div className="flex flex-col items-center text-center py-6">
              ...
              {user?.role && (
                <Badge className="mt-2 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400 capitalize">
                  {user.role}
                </Badge>
              )}
            </div>
            ...
            <div className="bg-white dark:bg-slate-800/80 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <div className="flex items-center gap-3 px-5 py-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-800 dark:text-slate-200 capitalize">{user?.role || 'user'}</p>
                </div>
              </div>
            </div>
